 ...
 */
class deleteSalidaBodegaActionClass extends controllerClass implements controllerActionInterface {
    ...
    public function execute() {
        try {
            if (request::getInstance()->isMethod('POST') and request::getInstance()->isAjaxRequest()) {
                ...
                salidaBodegaTableClass::delete($ids, true); /* el true es para el borrado logico  en bd false si no lo tiene */
