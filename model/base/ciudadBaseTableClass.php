...
class ciudadBaseTableClass extends tableBaseClass {
  ...
  const NOM_CIUDAD = 'nom_ciudad';
  const NOM_CIUDAD_LENGTH = 90;
  const DEPTO_ID = 'depto_id';
  ...
  function getNom_ciudad() {
    return $this->nom_ciudad;
  }

  function getDepto_id() {
  ...
  function setNom_ciudad($nom_ciudad) {
    $this->nom_ciudad = $nom_ciudad;
  }

  function setDepto_id($depto_id) {
