...
(
	...
	peso_cerdo varchar(30) NOT NULL,
...
/* Add Foreign Key: fk_hoja_vida */
ALTER TABLE hoja_vida ADD CONSTRAINT fk_hoja_vida_control_peso
	FOREIGN KEY (id_peso) REFERENCES control_peso (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;
...
/* Add Foreign Key: fk_salida_bodega */
ALTER TABLE salida_bodega ADD CONSTRAINT fk_salida_bodega_tipo_doc
