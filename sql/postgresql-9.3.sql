...
CREATE SEQUENCE detalle_entrada_id_seq INCREMENT BY 1;
...
CREATE SEQUENCE detalle_salida_id_seq INCREMENT BY 1;
...
(
	...
	desc_tipo_id varchar(60) NOT NULL,
	created_at TIMESTAMP DEFAULT now() NOT NULL,
    updated_at TIMESTAMP DEFAULT now() NOT NULL,
	deleted_at TIMESTAMP NULL
);
...
(
    ...
    nombre_cerdo varchar(10) NOT NULL,
	created_at TIMESTAMP DEFAULT now() NOT NULL,
    updated_at TIMESTAMP DEFAULT now() NOT NULL,
	deleted_at TIMESTAMP NULL
);
...
(
    ...
    fecha_montada varchar(10) NOT NULL,
    id_padre varchar(12) NOT NULL,
    hoja_vida_id BIGINT NOT NULL,
	created_at TIMESTAMP DEFAULT now() NOT NULL,
    updated_at TIMESTAMP DEFAULT now() NOT NULL,
	deleted_at TIMESTAMP NULL
...
/******************** Add Table:detalle_entradaBodega ************************/

/* Build Table Structure */
CREATE TABLE detalle_entrada
(
	id BIGINT DEFAULT nextval('public.detalle_entrada_id_seq'::regclass) NOT NULL,
	cantidad BIGINT NOT NULL,
    valor BIGINT NOT NULL,
...
/* Add Primary Key */
ALTER TABLE detalle_entrada ADD CONSTRAINT pkdetalle_entrada
	PRIMARY KEY (id);
...
/******************** Add Table:detalle_salidaBodega ************************/

/* Build Table Structure */
CREATE TABLE detalle_salida
(
	id BIGINT DEFAULT nextval('public.detalle_salida_id_seq'::regclass) NOT NULL,
	cantidad BIGINT NOT NULL,
...
/* Add Primary Key */
ALTER TABLE detalle_salida ADD CONSTRAINT pkdetalle_salida
	PRIMARY KEY (id);
...
ALTER TABLE control_peso ADD CONSTRAINT fk_control_peso_empleado
...
/* Add Foreign Key: fk_control_peso */
ALTER TABLE control_peso ADD CONSTRAINT fk_control_peso_unidad_hoja_vida
...
ALTER TABLE detalle_entrada  ADD CONSTRAINT fk_detalle_entrada_entrada_bodega
	FOREIGN KEY (entrada_bodega_id) REFERENCES entrada_bodega (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;

/* Add Foreign Key: fk_detalle_entradaB */
ALTER TABLE detalle_entrada  ADD CONSTRAINT fk_detalle_entrada_insumo
	FOREIGN KEY (insumo_id) REFERENCES insumo (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;

/* Add Foreign Key: fk_detalle_entradaB */
ALTER TABLE detalle_entrada  ADD CONSTRAINT fk_detalle_entrada_unidad_medida
	FOREIGN KEY (unidad_medida_id) REFERENCES unidad_medida (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE detalle_salida  ADD CONSTRAINT fk_detalle_salida_salida_bodega
	FOREIGN KEY (salida_bodega_id) REFERENCES salida_bodega (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;

/* Add Foreign Key: fk_detalle_salidaB */
ALTER TABLE detalle_salida  ADD CONSTRAINT fk_detalle_salida_unidad_medida
	FOREIGN KEY (unidad_medida_id) REFERENCES unidad_medida (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;

/* Add Foreign Key: fk_detalle_salidaB */
ALTER TABLE detalle_salida  ADD CONSTRAINT fk_detalle_salida_insumo
	FOREIGN KEY (insumo_id) REFERENCES insumo (id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;
