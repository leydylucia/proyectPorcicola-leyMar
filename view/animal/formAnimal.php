    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO_ID, TRUE) ?>" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputNombre') or request::getInstance()->hasPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO_ID, true))) ? request::getInstance()->getPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO_ID, true)) : ((isset($objHojaVida[0])) ? $objHojaVida[0]->$genero_id_b : '') ?>"  type="text" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO_ID, true) ?>" placeholder="<?php echo i18n::__('genre') ?>"><?php echo i18n::__('select_gender')?></option>
...
<!--    <div class="form-group </?php echo (session::getInstance()->hasFlash(hojaVidaTableClass::getNameField(hojaVidaTableClass::GENERO, true)) === true) ? 'has-error has-feedback' : '' ?>">
    ...
    <div class="col-xs-9">
        <select class="form-control" id="<?php hojaVidaTableClass::getNameField(hojaVidaTableClass::ESTADO_ID, TRUE) ?>" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::ESTADO_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputEstado') or request::getInstance()->hasPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::ESTADO_ID, true))) ? request::getInstance()->getPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::ESTADO_ID, true)) : ((isset($objHojaVida[0])) ? $objHojaVida[0]->$estado_id_p : '') ?>"  type="text" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::ESTADO_ID, true) ?>" placeholder="<?php echo i18n::__('state') ?>"><?php echo i18n::__('select_state')?></option>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php hojaVidaTableClass::getNameField(hojaVidaTableClass::LOTE_ID, TRUE) ?>" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::LOTE_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputLote') or request::getInstance()->hasPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::LOTE_ID, true))) ? request::getInstance()->getPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::LOTE_ID, true)) : ((isset($objHojaVida[0])) ? $objHojaVida[0]->$lote_id_e : '') ?>"  type="text" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::LOTE_ID, true) ?>" placeholder="<?php echo i18n::__('state') ?>"><?php echo i18n::__('select_batch')?></option>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php hojaVidaTableClass::getNameField(hojaVidaTableClass::RAZA_ID, TRUE) ?>" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::RAZA_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputRaza') or request::getInstance()->hasPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::RAZA_ID, true))) ? request::getInstance()->getPost(hojaVidaTableClass::getNameField(hojaVidaTableClass::RAZA_ID, true)) : ((isset($objHojaVida[0])) ? $objHojaVida[0]->$raza_id_a : '') ?>"  type="text" name="<?php echo hojaVidaTableClass::getNameField(hojaVidaTableClass::RAZA_ID, true) ?>" placeholder="<?php echo i18n::__('race') ?>"><?php echo i18n::__('select_race')?></option>
