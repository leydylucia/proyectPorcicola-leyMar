    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php controlTableClass::getNameField(controlTableClass::ID, TRUE) ?>" name="<?php echo controlTableClass::getNameField(controlTableClass::HOJA_VIDA, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputCerdo') or request::getInstance()->hasPost(controlTableClass::getNameField(controlTableClass::HOJA_VIDA, true))) ? request::getInstance()->getPost(controlTableClass::getNameField(controlTableClass::HOJA_VIDA, true)) : ((isset($objControl[0])) ? $objControl[0]->$hoja_vida_id_h : '') ?>"  type="text" name="<?php echo controlTableClass::getNameField(controlTableClass::HOJA_VIDA, true) ?>" placeholder="<?php echo i18n::__('pig') ?>" ><?php echo i18n::__('select_pig')?></option>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php controlTableClass::getNameField(controlTableClass::ID, TRUE) ?>" name="<?php echo controlTableClass::getNameField(controlTableClass::UNIDAD_MEDIDA_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputCerdo') or request::getInstance()->hasPost(controlTableClass::getNameField(controlTableClass::UNIDAD_MEDIDA_ID, true))) ? request::getInstance()->getPost(controlTableClass::getNameField(controlTableClass::UNIDAD_MEDIDA_ID, true)) : ((isset($objControl[0])) ? $objControl[0]->$unidad_medida_id_p : '') ?>"  type="text" name="<?php echo controlTableClass::getNameField(controlTableClass::UNIDAD_MEDIDA_ID, true) ?>" placeholder="<?php echo i18n::__('unit_measure') ?>" ><?php? echo i18n::__('select_unit_measure')></option>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php controlTableClass::getNameField(controlTableClass::ID, TRUE) ?>" name="<?php echo controlTableClass::getNameField(controlTableClass::EMPLEADO_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputEmpleado') or request::getInstance()->hasPost(controlTableClass::getNameField(controlTableClass::EMPLEADO_ID, true))) ? request::getInstance()->getPost(controlTableClass::getNameField(controlTableClass::EMPLEADO_ID, true)) : ((isset($objControl[0])) ? $objControl[0]->$control_id_c : '') ?>"  type="text" name="<?php echo controlTableClass::getNameField(controlTableClass::EMPLEADO_ID, true) ?>" placeholder="<?php echo i18n::__('employee') ?>"><?php echo i18n::__('select_employee')?></option>
