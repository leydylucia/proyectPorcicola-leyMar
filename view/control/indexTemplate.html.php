        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" id="filtersForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('control', 'index') ?>">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Control Peso</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="filterControl" name="filter[control]" placeholder="control peso">
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <button type="button" onclick="$('#filtersForm').submit()" class="btn btn-primary">Filtrar</button>
            </div>
          </div>
        </div>
      </div>
