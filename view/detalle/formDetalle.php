        ...
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <select class="form-control" id="<?php detalleEntradaTableClass::getNameField(detalleEntradaTableClass::UNIDAD_MEDIDA_ID, TRUE) ?>" name="<?php echo detalleEntradaTableClass::getNameField(detalleEntradaTableClass::UNIDAD_MEDIDA_ID, TRUE); ?>">
                    <option value="<?php echo (session::getInstance()->hasFlash('inputUnidadMedida') or request::getInstance()->hasPost(detalleEntradaTableClass::getNameField(detalleEntradaTableClass::UNIDAD_MEDIDA_ID, true))) ? request::getInstance()->getPost(detalleEntradaTableClass::getNameField(detalleEntradaTableClass::UNIDAD_MEDIDA_ID, true)) : ((isset($objDetalle[0])) ? $objDetalle[0]->$unidad_medida_u  : '') ?>"><?php echo i18n::__('select_unit_measure')?></option>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <select class="form-control" id="<?php detalleEntradaTableClass::getNameField(detalleEntradaTableClass::INSUMO_ID, TRUE) ?>" name="<?php echo detalleEntradaTableClass::getNameField(detalleEntradaTableClass::INSUMO_ID, TRUE); ?>">
                    <option value="<?php echo (session::getInstance()->hasFlash('inputInsumo') or request::getInstance()->hasPost(detalleEntradaTableClass::getNameField(detalleEntradaTableClass::INSUMO_ID, true))) ? request::getInstance()->getPost(detalleEntradaTableClass::getNameField(detalleEntradaTableClass::INSUMO_ID, true)) : ((isset($objDetalle[0])) ? $objDetalle[0]->$insumoId_p  : '') ?>"><?php echo i18n::__('select_product')?></option>
