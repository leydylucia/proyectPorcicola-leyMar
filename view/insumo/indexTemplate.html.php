...
<?php $nomproveedor = proveedorTableClass::NOMBRE ?>
                        ...
                        <?php foreach ($objInsumo as $insumo): ?> 
                            <tr class="text-info bg-info">
                                ...
                                <td>
                                    ...
                                    <a href="#" data-target="#myModalDelete<?php echo $insumo->$id ?>" data-toggle="modal" class="btn btn-danger btn-xs"><?php echo i18n::__('Delete') ?></a>
                                </td>
                            </tr>
