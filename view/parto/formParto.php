    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php partoTableClass::getNameField(partoTableClass::HOJA_VIDA_ID, TRUE) ?>" name="<?php echo partoTableClass::getNameField(partoTableClass::HOJA_VIDA_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputCerdo') or request::getInstance()->hasPost(partoTableClass::getNameField(partoTableClass::HOJA_VIDA_ID, true))) ? request::getInstance()->getPost(partoTableClass::getNameField(partoTableClass::HOJA_VIDA_ID, true)) : ((isset($objParto[0])) ? $objParto[0]->$hoja_vida_id_p : '') ?>"  type="text" name="<?php echo partoTableClass::getNameField(partoTableClass::HOJA_VIDA_ID, true) ?>" placeholder="<?php echo i18n::__('pig') ?>"><?php echo i18n::__('select_pig')?></option>
