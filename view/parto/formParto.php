...
<?php foreach ($objHojaVida as $hojaVida): ?>
            <option <?php echo (isset($objParto[0]->$hoja_vida_id_p) === true and $objParto[0]->$hoja_vida_id_p == $hojaVida->$hoja_vida_id) ? 'selected' : '' ?> value="<?php echo $hojaVida->$hoja_vida_id ?>">
  <?php echo $hojaVida->$cerdo ?>
            </option>
<?php endforeach; ?>
        </select>
      </div>
