...
<div class="container"><!--en form tan solo se agrega el role y class para hacer boostrap-->
 ...
 <a href="http://localhost/proyecto/web/index.php/depto"><?php echo i18n::__('volver') ?> </a>
 <a href="http://localhost/proyecto/web/index.php/proveedor"><?php echo i18n::__('inicio') ?> </a> 
