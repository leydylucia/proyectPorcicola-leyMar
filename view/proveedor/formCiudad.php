    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" id="<?php ciudadTableClass::getNameField(ciudadTableClass::DEPTO_ID, TRUE) ?>" name="<?php echo ciudadTableClass::getNameField(ciudadTableClass::DEPTO_ID, TRUE); ?>">
            <option value="<?php echo (session::getInstance()->hasFlash('inputCiudad') or request::getInstance()->hasPost(ciudadTableClass::getNameField(ciudadTableClass::DEPTO_ID, true))) ? request::getInstance()->getPost(ciudadTableClass::getNameField(ciudadTableClass::DEPTO_ID, true)) : ((isset($objCiudad[0])) ? $objCiudad[0]->$depto_id_c : '') ?>"  type="text" name="<?php echo ciudadTableClass::getNameField(ciudadTableClass::DEPTO_ID, true) ?>" placeholder="<?php echo i18n::__('name_dept') ?>"><?php echo i18n::__('select_department')?></option>
