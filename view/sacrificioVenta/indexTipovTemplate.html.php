...
<div class="container container-fluid">
    <div class="page-header titulo">
        <h1><?php echo i18n::__('type_sale') ?></h1>  
    </div>
...
<div class="container container-fluid">
    ...
    <div style="margin-bottom: 10px; margin-top: 30px">
        ...
        <a href="<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'insertTipov') ?>" class="btn btn-success btn-xs"><?php echo i18n::__('new') ?></a>
    ...
    <div class="container">
        <div class="table-responsive">
            <form id="frmDeleteAll" id ="filterForm"action="<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'deleteSelectTipov') ?>" method="POST">
                    ...
                    <tbody>
                        <?php foreach ($objTipoV as $tipoV): ?> 
                            <tr class="text-info bg-info">
                                ...
                                <td>
                                    <a href="<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'verTipov', array(tipovTableClass::ID => $tipoV->$id)) ?>"class="btn btn-warning btn-xs"><?php echo i18n::__('see') ?></a>
                                    <a href="<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'editTipov', array(tipovTableClass::ID => $tipoV->$id)) ?>" class="btn btn-primary btn-xs"><?php echo i18n::__('publish') ?></a>
                        ...
                        <div class="modal fade" id="myModalDelete<?php echo $tipoV->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo i18n::__('cancel') ?></button>
                                        <button type="button" class="btn btn-danger" onclick="eliminar(<?php echo $tipoV->$id ?>, '<?php echo tipovTableClass::getNameField(tipovTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'deleteTipov') ?>')"><?php echo i18n::__('Delete') ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="text-right">
                página <select id="slqPaginador" onchange="paginador(this, '<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'indexTipov') ?>')">
    ...
    <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('sacrificioVenta', 'deleteTipov') ?>" method="POST">
