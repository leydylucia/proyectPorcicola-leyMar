<!--@var $objVacunacion
@var $deosis,$precio,$tipoInsumo,$fechaFabricacion,$fechaVencimiento,$vacunacionId-->
        ...
        <div class="col-xs-9">
            <select class="form-control" id="<?php vacunacionTableClass::getNameField(vacunacionTableClass::ID_CERDO, TRUE) ?>" name="<?php echo vacunacionTableClass::getNameField(vacunacionTableClass::ID_CERDO, TRUE); ?>">
                ...
                <?php foreach ($objHojaVida as $hojaVida): ?><!--validacion para traer dato  de foranea en editar-->
                    ...
                    <option <?php echo (request::getInstance()->hasPost(vacunacionTableClass::getNameField(vacunacionTableClass::ID_CERDO, true)) === true and request::getInstance()->getPost(vacunacionTableClass::getNameField(vacunacionTableClass::ID_CERDO, true)) == $hojaVida->$idCerdo) ? 'selected' : (isset($objVacunacion[0]->$idCerdo_c) === true and $objVacunacion[0]->$idCerdo_c == $hojaVida->$idCerdo) ? 'selected' : '' ?> value="<?php echo $hojaVida->$idCerdo ?>"><?php echo hojaVidaTableClass::getNameHojaVida($hojaVida->$idCerdo) ?></option><!--sostenimiento de dato en foranea-->
